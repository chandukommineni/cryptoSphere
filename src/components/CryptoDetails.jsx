...
import { fetchCryptoDetails,fetchCryptoHistory } from "../store/cryptoSlice";
...
const CryptoDetails = () => {
  ...
  const cryptoDetails=useSelector(state=>state.Data.cryptoDetails.data?.coin)
  const coinHistory=useSelector(state=>state.Data.cryptoHistory)
  if (!cryptoDetails){
    return <Loader/>
  }
  const stats = [
       ...
       <Col className="stats-container">
        <Col className="coin-value-statistics">
          <Col className="coin-value-statistics-heading">
            <Title level={3} className="coin-details-heading" style={{textAlign:"center"}}>{cryptoDetails?.name} Value Statistics</Title>
        ...
        <Col className="coin-value-statistics">
          <Col className="coin-value-statistics-heading" style={{textAlign:"center"}}>
